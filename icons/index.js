...
export { default as iconDeleteForever } from './entities/icon-delete-forever';
export { default as iconDelete } from './entities/icon-delete';
...
export { default as iconHistory } from './entities/icon-history';
...
export { default as iconNoteAdd } from './entities/icon-note-add';
export { default as iconPowerSettingsNew } from './entities/icon-power-settings-new';
...
export { default as iconRoom } from './entities/icon-room';
